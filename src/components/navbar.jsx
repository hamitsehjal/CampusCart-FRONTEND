...
import { RiShoppingBasket2Line, RiMenuLine, RiCloseCircleLine, RiLoginBoxLine, RiBodyScanLine } from 'react-icons/ri'
        ...
        <nav className='bg-campus-red flex flex-col'>
            <div className="flex flex-row justify-between p-4 md:p-2  text-campus-background">
                ...
                <div>
                    <Link className="flex flex-row gap-x-2 items-center justify-start text-2xl" href='#'>
                        ...
                        <span className="text-lg md:text-2xl font-noto_serif">CampusCart</span>
                    </Link>
                </div>
                {/* Home 
            Contact US  */}
            ...
            Sign Up  */}
                <div className="hidden lg:flex flex-row gap-x-4 items-center justify-end text-xl">
                    <Link className='px-4 py-2 font-noto_serif text-sm bg-campus-text text-campus-background rounded-3xl hover:bg-campus-background hover:text-campus-text' href='#'>Login</Link>
