...
const OrderConfirmation = () => {
  removeCartItems();
  const { user_name } = readToken() || "Ema";
  return (
    <>
      <main className="py-10 px-10 bg-white">
        <h1 className="text-3xl font-bold mb-2 font-noto_serif">Thank You <span className="text-5xl">{user_name}</span> for shopping with Us!</h1>
